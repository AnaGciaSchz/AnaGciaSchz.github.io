...
* [My Professional Story](#my-professional-story)
  * [Student Representation](#student-representation)
  * [Projects](#projects)
  * [Software Engineering and DevRel](#software-engineering-and-devrel)
  * [What am I doing now?](#what-am-i-doing-now)
* [Me as a Person](#me-as-a-person)
  * [Hobbies](#hobbies)
  * [What is 'anuskuskus'?](#what-is-anuskuskus)
  * [How to contact me](#how-to-contact-me)

![Photo taken during ShuttleCon Third edition](1.jpg)

<h2 id="my-professional-story">My Professional Story</h2>

<h3 id="student-representation">Student Representation</h3>
...
* **Self-Managed Components**: I encapsulated the [Empathy Platform](https://docs.empathy.co/) search product into a Docker container, creating a streamlined, user-friendly setup with documentation and tutorials. Check out the [Empathy Self-Managed Components](https://docs.empathy.co/understand-empathy-platform/about-empathy-platform/self-managed-components-overview.html) and the [code](https://github.com/empathyco/empathy-self-managed-components).

<h3 id="software-engineering-and-devrel">Software Engineering and DevRel</h3>
...
All of this work led to a pivotal moment: becoming the company’s first DevRel. In this role, I embraced a variety of responsibilities, from generating content and developing marketing strategies to leading projects and editing videos. Each challenge was an opportunity to grow, and that journey shaped who I am today.

<h3 id="what-am-i-doing-now">What am I doing now?</h3>

For the past year, I’ve been part of Next Digital, growing as a Backend Engineer (my current role) while also making space again for the talks and community activities I love. 

I’ve had the chance to speak at several events (check out the [my-talks](/my-talks/) section to see them!), collaborate with [Sirviendo Código](https://sirviendocodigo.com/), and even step into the classroom as a guest lecturer, teaching computer science courses at universities across Spain thanks to their initiatives.

<h2 id="me-as-a-person">Me as a Person</h2>

<h3 id="hobbies">Hobbies</h3>

I’m currently taking theatre classes, and I’ve had the opportunity to work on five productions so far. I even landed a role in a professional theatre representation as an actress, an experience that has been both challenging and rewarding.

In my free time, I enjoy painting and coding personal projects just for fun. I’ve also started going to karate classes, singing classes and I've overcome my fear of driving a car. Ths has been quite a year :)
...
<h3 id="what-is-anuskuskus">What is 'anuskuskus'?</h3>
